  ...
  <div class="v-step" :id="'v-step-' + hash" :ref="'v-step-' + hash">
    ...
    <slot name="actions">
      <div class="v-step__buttons">
        <button @click.prevent="stop" v-if="!isLast" class="v-step__button skip">{{ labels.buttonSkip }}</button>
        <button @click.prevent="previousStep" v-if="!isFirst" class="v-step__button prev">{{ labels.buttonPrevious }}</button>
        <button @click.prevent="nextStep" v-if="!isLast" class="v-step__button next">{{ labels.buttonNext }}</button>
        <button @click.prevent="stop" v-if="isLast" class="v-step__button stop">{{ labels.buttonStop }}</button>
      </div>
    </slot>
